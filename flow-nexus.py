...
# ///
"""
CLI Wrapper for Flow Nexus MCP
Auto-generated wrapper with 4-level progressive disclosure.

Run with: uv run flow-nexus.py [COMMAND] [ARGS]
...
QUICK_HELP = """Flow Nexus MCP

Available functions:
  swarm_init                     Initialize swarm
  swarm_scale                    Scale swarm
  agent_spawn                    Spawn agents
  sandbox_create                 Create sandbox
  sandbox_execute                Execute in sandbox

Use:
  uv run flow-nexus.py list
  uv run flow-nexus.py info FUNCTION_NAME
  uv run flow-nexus.py example FUNCTION_NAME
  uv run flow-nexus.py FUNCTION_NAME [ARGS]
...
FUNCTION_EXAMPLES = {
    "swarm_init": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py swarm_init"
        }
    ],
    "swarm_scale": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py swarm_scale"
        }
    ],
    "agent_spawn": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py agent_spawn"
        }
    ],
    "sandbox_create": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py sandbox_create"
        }
    ],
    "sandbox_execute": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py sandbox_execute"
        }
    ]
}
...
def main():
    parser = argparse.ArgumentParser(
        prog="flow-nexus",
        description="Flow Nexus MCP Wrapper",
...
EXAMPLES:
  ...
  uv run flow-nexus.py list
  uv run flow-nexus.py info my_function
  uv run flow-nexus.py example my_function
  uv run flow-nexus.py my_function --arg value

...
# ///
"""
CLI Wrapper for Semly MCP
Auto-generated wrapper with 4-level progressive disclosure.

Run with: uv run semly.py [COMMAND] [ARGS]
...
QUICK_HELP = """Semly MCP

Available functions:
  outline                        Generate code outline
  explain                        Explain code
  list_indexed_projects          List projects
  retrieve                       Retrieve code chunks
  locate                         Find code

Use:
  uv run semly.py list
  uv run semly.py info FUNCTION_NAME
  uv run semly.py example FUNCTION_NAME
  uv run semly.py FUNCTION_NAME [ARGS]
...
FUNCTION_INFO = {
    "outline": {
        "description": "Generate code outline",
        "parameters": [],
    ...
    "retrieve": {
        "description": "Retrieve code chunks",
        "parameters": [],
        "returns": "Dict[str, Any]"
    },
    "locate": {
...
FUNCTION_EXAMPLES = {
    "outline": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py outline"
        }
    ],
    "explain": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py explain"
        }
    ],
    "list_indexed_projects": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py list_indexed_projects"
        }
    ],
    "retrieve": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py retrieve"
        }
    ],
    "locate": [
        {
            "title": "Example",
            "command": "uv run WRAPPER.py locate"
        }
    ]
}
...
EXAMPLES:
  ...
  uv run semly.py list
  uv run semly.py info my_function
  uv run semly.py example my_function
  uv run semly.py my_function --arg value
